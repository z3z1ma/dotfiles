...
return {
  ...
  before_init = function(init_params, config)
    -- See https://github.com/zed-extensions/java/issues/27
    local bzl_supp = vim.uv.fs_stat("/opt/java/p2-repository")
    if bzl_supp and bzl_supp.type == "directory" then
      init_params.initializationOptions = {
        bundles = {
          "/opt/java/p2-repository/org.eclipse.equinox.event.jar",
          "/opt/java/p2-repository/com.github.ben-manes.caffeine.jar",
          "/opt/java/p2-repository/org.jsr-305.jar",
          "/opt/java/p2-repository/org.fusesource.jansi.jar",
          "/opt/java/p2-repository/com.google.protobuf.jar",
          "/opt/java/p2-repository/com.salesforce.bazel.importedsource.jar",
          "/opt/java/p2-repository/com.salesforce.bazel.sdk.jar",
          "/opt/java/p2-repository/com.salesforce.bazel.eclipse.core.jar",
          "/opt/java/p2-repository/com.salesforce.bazel.eclipse.jdtls.jar",
        },
      }
    end
  end,
