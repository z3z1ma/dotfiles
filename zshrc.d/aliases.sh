...
alias mkpy39envrc="echo 'use flake $(realpath ~/.environments)#python39 --impure --command zsh' >> .envrc && direnv allow"
alias mkgoenvrc="echo 'use flake $(realpath ~/.environments)#go --impure --command zsh' >> .envrc && direnv allow"
alias mkrustenvrc="echo 'use flake $(realpath ~/.environments)#rust --impure --command zsh' >> .envrc && direnv allow"
alias mkelixirenvrc="echo 'use flake $(realpath ~/.environments)#elixir --impure --command zsh' >> .envrc && direnv allow"
alias mkclojureenvrc="echo 'use flake $(realpath ~/.environments)#clojure --impure --command zsh' >> .envrc && direnv allow"
alias mkscalaenvrc="echo 'use flake $(realpath ~/.environments)#scala --impure --command zsh' >> .envrc && direnv allow"
alias mkzigenvrc="echo 'use flake $(realpath ~/.environments)#zig --impure --command zsh' >> .envrc && direnv allow"
